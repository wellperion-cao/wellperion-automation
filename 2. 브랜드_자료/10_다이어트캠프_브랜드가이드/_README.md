...
| 폴더 | 무엇을 두나 | 상태 |
|---|---|---|
| `00_대표님_원자료/` | 대표님께 받은 것 그대로(설문 답변 txt · 커리큘럼 가격표 pptx · 재활운동솔루션 pptx). 수정 금지 — 새로 받으면 파일을 추가만 한다. `사진/` = 대표님 사진(받을 목록 `_받을_사진.md`) | 3개 + 사진 0장 |
| `01_브랜드가이드/` | 다캠 브랜드가이드(한 줄·어투·쓰는 말/안 쓰는 말·색·로고·사진·계정 규칙 + SEO·GEO·AEO 셋업 §3) | v0.1 초안 (색·로고·계정 미수령) |
| `02_회사소개서/` | 다캠 회사소개서(센터 소개·프로그램·재활 솔루션·상품) | v0.1 초안 (위치·연락처·사진 미수령) |
| `03_전략_구상안/` | 다캠 운영전략 구상안(목표 KPI·채널·90일 계획) | v0.1 초안 (KPI·기준선 확정 전) |
