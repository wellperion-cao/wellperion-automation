...
CreateObject("WScript.Shell").Run "cmd /c cd /d C:\Users\jjky0\welperion-automation& set PYTHONIOENCODING=utf-8& set WEEKLY_REVIEW_LIVE_SEND=1& C:\Python314\python.exe -u scripts\weekly_self_review.py >> logs\weekly_self_review.log 2>&1", 0, False
