...
_CLOSING_BY_DOW = {
    0: "우리가 오늘 챙기는 한 가지가 회원 한 분의 하루를 바꿉니다. 그 하루가 쌓여 웰페리온이 됩니다.",
    1: "회원분은 어제 불편했던 것을 오늘도 겪을지 봅니다. 어제 것을 먼저 닫는 이유입니다.",
    2: "점검은 아무 일도 일어나지 않게 만드는 일입니다. 티가 안 나는 날이 가장 잘한 날입니다.",
    3: "접수 한 건은 회원 한 분이 우리에게 말을 걸어 주신 것입니다. 답이 있어야 다음에도 말해 주십니다.",
    4: "이번 주에 우리가 닫은 것들이 주말 회원분들의 하루가 됩니다.",
    5: "주말은 회원분들이 가장 오래 머무는 날입니다. 오늘 한 번 더 살핀 자리가 그 시간을 만듭니다.",
    6: "주말은 회원분들이 가장 오래 머무는 날입니다. 오늘 한 번 더 살핀 자리가 그 시간을 만듭니다.",
}
