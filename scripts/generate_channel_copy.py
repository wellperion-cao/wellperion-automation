...
#     (당근 CTA 유무는 브랜드 스킬 문서(2026-06-24, URL 넣지 않음)와 scripts/cta_utm.py 의
#      설계 원칙④(2026-07-09 GM 재정립, "텍스트 채널=카카오·당근 모두 깨끗한 CTA 1줄 보장")가
#      상충한다. 실측 3건 중 2건(L1 수영·L2 PT)이 CTA 포함이고, 더 최신·실행되는 코드 SSOT인
#      cta_utm.py 도 CTA 포함을 원칙으로 삼으므로 이 생성기는 CTA 포함을 따른다.)
#
