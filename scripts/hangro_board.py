...
CLEVEL_NICK: dict[str, str] = {
    ...
    "CFO": "시뽀",   "AI CFO": "시뽀",
    "CHRO": "시로",  "AI CHRO": "시로",
    "CBO": "시보",   "AI CBO": "시보",   # 신설 2026-09-02 — 빠져 있어 시보 배가 항로에 0척으로 보였다(2026-09-03 실측)
}
...
_DUE_HYGIENE_LABELS = {
    ...
    "⑥완료예정일없음": ("체크 항목에 완료예정일 없음", "월간운영계획"),
    "⑦완료예정일지남": ("체크 항목 완료예정일 지남", "월간운영계획"),
    "⑧담당없음": ("GM 직접 관장 체크 항목에 담당자 표기 없음", "월간운영계획"),
    "⑨닮은제목": ("전사일정에 제목이 닮은 중복 일정", "전사일정"),
    "⑩완료짝미래일정": ("완료된 건과 이름 닮은 미래 일정이 같이 남음", "전사일정"),
    "⑪반복멈춤": ("반복 일정이 기한 지나고도 완료 기록 없음", "전사일정"),
    "⑫지시미체크": ("GM 지시 줄이 아직 체크 안 된 것", "GM업무"),
    "⑬연동어긋남": ("네 화면이 서로 어긋난 자리", "GM업무·전사일정·업무SSOT"),
}
