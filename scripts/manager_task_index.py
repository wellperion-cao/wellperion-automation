...
<meta http-equiv="refresh" content="0; url=../todo/업무 현황 SSOT.html">
<title>웰페리온 · 중간관리자 업무 → 업무시스템</title>
<!-- 중간관리자 업무목차는 업무 SSOT 로 단일화됐습니다 (GM 지시 2026-09-17). 업무는 업무 현황 SSOT ·
     사람별 보기는 업무 현황 SSOT ?owner=이름 · 평가는 ERP 관리자 페이지 「평가」 탭. 이 파일은 옛 링크용 이동 스텁입니다. -->
</head><body style="font-family:sans-serif;padding:24px">업무 현황 SSOT 로 이동합니다… <a href="../todo/업무 현황 SSOT.html">바로 가기</a></body></html>
"""
