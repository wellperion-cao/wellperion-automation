...
AI_SIGNOFF = "AI 웰리 드림"   # 2026-09-05 사람 방(★부서장·★운영부) 발신은 전부 웰리 이름(약속 L24 · 작성자=AI 닉네임 규칙)
...
# ★2026-09-02 GM 확정 — 24시간으로 당겼다(48시간 → 24시간 · 그전 14일).
#   GM 원문: "문의했을 때 빠르게 컨택하고 … 24시간 내를 기준으로 해줘."
#   담당이 없으면 컨택 자체가 시작되지 않는다. 하루가 지나도 주인이 없으면 종목 팀장 이름으로
#   붙여 컨택이 시작되게 한다 — 접수 쪽 24시간 기준과 같은 시계다(약속 L01, 기준은 한 벌).
AUTO_ASSIGN_MIN_DAYS = 1   # 24시간(GM 확정 2026-09-02 · 종전 48시간·14일) — 「담당 없음」을 구조로 0으로
TEAM_LEAD_BY_SPORT = [
