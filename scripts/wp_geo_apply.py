 ...
 "@graph": [
  ...
  },
  {
   ...
   "mainEntity": [
    ...
    { "@type": "Question", "name": "강습도 예약제인가요?", "acceptedAnswer": { "@type": "Answer", "text": "네, P.T·수영·체조·골프·스쿼시·G.X 등 모든 강습은 사전 예약제로 진행하며 워크인 등록은 운영하지 않습니다." } },
...
async def step1_header_inject(page) -> str:
    ...
    if "GEO(생성형 검색 최적화) 구조화 데이터 3종 — 배1000" in current:
        return "SKIP(이미 삽입됨)"
