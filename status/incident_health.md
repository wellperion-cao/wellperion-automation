# 🛡️ 재발방지 회귀감시
_갱신: 2026-09-15 · 자동 산출(ssot/incident_regression_monitor.py)_

## 판정: ⚠️ 회귀 감지

| 검사 | 결과 |
|---|---|
| 신규 캐논 발산(baseline 초과) | 118건 · official_phone, inquiry_path, telegram_chat_id, bot_token_key, company_scale, company_address, report_bot_handle, slogan_en, slogan_kr, naver_cafe_club_id, sales_year_target, golf_bay_systems, member_type_jungdangi, aws_server_eip, positioning_kr, official_one_liner_kr, ai_sender_name, rule:cta_channel_rules, rule:gm_approval_gate_5 |
| 가드 자산 무결 | OK |
| 박제 무결(GUARDED) | OK |
| 결정정합 누출(leaked · §6.3) | OK(0건) |

### ⚠️ 신규 드리프트(회귀)
- **official_phone**: scripts/poc-evidence/home_page6_content_backup_20260905_111625.txt, scripts/poc-evidence/home_page6_content_backup_20260905_111658.txt, server/counselbot/tenants/1_wellperion.json, server/counselbot/tenants/1_wellperion_qa.json, server/erp_api/seed_faq/1_wellperion.json, status/_private/backup_monthly_ops_plan_20260915.json, status/drafts/dlive_ip_request_20260902.md, status/drafts/dlive_msg_templates_confirmed_20260910.md, status/monthly_ops_plan.json, status/reception_rows_cache.json
- **inquiry_path**: scripts/graphify-out/cache/ast/v0.9.31/5c03e52a8ad498d816c2c320d33cba9f68866bd24448b8a01ded45950db29c26.json, scripts/graphify-out/graph.json, scripts/poc-evidence/home_page6_content_backup_20260905_111625.txt, scripts/poc-evidence/home_page6_content_backup_20260905_111658.txt, scripts/tenants/wellperion.json, scripts/wordpress_admin_playwright.py, server/counselbot/tenants/1_wellperion.json, server/counselbot/tenants/1_wellperion_qa.json, server/erp_api/api_chat.py, server/erp_api/seed_faq/1_wellperion.json, status/_private/backup_monthly_ops_plan_20260915.json, status/coo_page_guard.json, status/counsel_questions_summary.json, status/drafts/blog_survey_reply_20260902.md, status/gas_push_baseline.json, status/monthly_ops_plan.json, status/monthly_ops_plan_이력.md, status/schedule_ssot.json
...
- **company_scale**: scripts/make_fb_cover.py, scripts/poc-evidence/home_page6_content_backup_20260905_111625.txt, scripts/poc-evidence/home_page6_content_backup_20260905_111658.txt, server/counselbot/tenants/1_wellperion_qa.json, server/erp_api/seed_faq/1_wellperion.json, status/drafts/blog_survey_reply_20260902.md, status/gm_personal_routine.json, status/page_hygiene_proposal_20260802.md, status/page_hygiene_proposal_20260823.md, status/page_hygiene_proposal_20260913.md
- **company_address**: server/counselbot/tenants/1_wellperion.json, server/counselbot/tenants/1_wellperion_qa.json, server/erp_api/seed_faq/1_wellperion.json, status/_private/backup_20260826_194447_LOSS보관.json, status/_private/backup_20260826_194447_유효회원.json, status/_private/backup_20260826_194447_종료회원.json, status/loss_archive_backup_20260813.json, status/member_active_snapshot.json, status/member_ended_snapshot.json
- **report_bot_handle**: scripts/kakao_auto_daily_report.py, scripts/sales_report_server_send.py
...
- **aws_server_eip**: 3. 웰페리온 가이드/cto/AWS_ERP_운영가이드.html, 3. 웰페리온 가이드/wellperion_guide(main).html, qa_screenshots/auto_status_now.txt, status/_private/backup_monthly_ops_plan_20260915.json, status/evening_wraps/2026-09-04.json, status/monthly_ops_plan.json, status/monthly_ops_plan_이력.md, status/push_approvals.json, status/welly_auto_runner_state.json
- **positioning_kr**: 2. 브랜드_자료/웰페리온_기반_FOUNDATION.md, server/counselbot/tenants/1_wellperion.json, server/counselbot/tenants/1_wellperion_qa.json, server/erp_api/seed_faq/1_wellperion.json
- **official_one_liner_kr**: server/counselbot/tenants/1_wellperion_qa.json, server/erp_api/seed_faq/1_wellperion.json
- **ai_sender_name**: 2. 브랜드_자료/10_다이어트캠프_브랜드가이드/04_소통기록/소통기록.md, 2. 브랜드_자료/11_고척골프_조재오부장님/04_소통기록/소통기록.md, 2. 브랜드_자료/웰페리온_AI_C레벨_협업매뉴얼_2026-04-24.html, qa_screenshots/auto_status_now.txt, reports/260905_ERP권한_매트릭스.html, telegram_bot/bot.py, telegram_bot/daily_scheduler.py
- **rule:cta_channel_rules**: 2. 브랜드_자료/11_고척골프_조재오부장님/client.json, scripts/graphify-out/graph.json, status/gas_push_baseline.json, status/push_approvals.json
- **rule:gm_approval_gate_5**: 2. 브랜드_자료/11_고척골프_조재오부장님/client.json, scripts/graphify-out/graph.json, status/gas_push_baseline.json, status/push_approvals.json
