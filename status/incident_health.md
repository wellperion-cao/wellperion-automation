# 🛡️ 재발방지 회귀감시
_갱신: 2026-08-28 · 자동 산출(ssot/incident_regression_monitor.py)_

## 판정: ⚠️ 회귀 감지 · 경보 억제(직전과 동일 내용 · 지문 e55a69cdd1ec8e96)

| 검사 | 결과 |
|---|---|
| 신규 캐논 발산(baseline 초과) | 53건 · official_phone, inquiry_path, telegram_chat_id, bot_token_key, company_scale, company_address, report_bot_handle, sales_year_target, golf_bay_systems, rule:cta_channel_rules, rule:gm_approval_gate_5 |
| 가드 자산 무결 | OK |
| 박제 무결(GUARDED) | OK |
