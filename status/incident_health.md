# 🛡️ 재발방지 회귀감시
_갱신: 2026-09-17 · 자동 산출(ssot/incident_regression_monitor.py)_

## 판정: ⚠️ 회귀 감지

| 검사 | 결과 |
|---|---|
| 자체점검(제외 후 스캔 대상) | 4641건 |
| 신규 캐논 발산(baseline 초과) | 108건 · official_phone, inquiry_path, telegram_chat_id, bot_token_key, company_scale, company_address, report_bot_handle, slogan_en, slogan_kr, naver_cafe_club_id, sales_year_target, golf_bay_systems, aws_server_eip, positioning_kr, official_one_liner_kr, ai_sender_name, sales_year_target_2027, gm_principles, rule:cta_channel_rules, rule:gm_approval_gate_5 |
| 가드 자산 무결 | OK |
| 박제 무결(GUARDED) | OK |
