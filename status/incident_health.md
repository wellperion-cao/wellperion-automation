# 🛡️ 재발방지 회귀감시
_갱신: 2026-08-23 · 자동 산출(ssot/incident_regression_monitor.py)_

## 판정: ⚠️ 회귀 감지 · 경보 억제(직전과 동일 내용 · 지문 eb79b81d9195fa3f)

| 검사 | 결과 |
|---|---|
| 신규 캐논 발산(baseline 초과) | 49건 · official_phone, inquiry_path, telegram_chat_id, bot_token_key, company_scale, company_address, report_bot_handle, sales_year_target, golf_bay_systems, rule:cta_channel_rules, rule:gm_approval_gate_5 |
| 가드 자산 무결 | OK |
| 박제 무결(GUARDED) | OK |
