# 🛡️ 재발방지 회귀감시
_갱신: 2026-09-14 · 자동 산출(ssot/incident_regression_monitor.py)_

## 판정: ⚠️ 회귀 감지

| 검사 | 결과 |
|---|---|
| 신규 캐논 발산(baseline 초과) | 111건 · official_phone, inquiry_path, telegram_chat_id, bot_token_key, company_scale, company_address, report_bot_handle, slogan_en, slogan_kr, naver_cafe_club_id, sales_year_target, golf_bay_systems, member_type_jungdangi, aws_server_eip, positioning_kr, official_one_liner_kr, ai_sender_name, rule:cta_channel_rules, rule:gm_approval_gate_5 |
| 가드 자산 무결 | OK |
| 박제 무결(GUARDED) | OK |
| 결정정합 누출(leaked · §6.3) | OK(0건) |

### ⚠️ 신규 드리프트(회귀)
- **official_phone**: scripts/poc-evidence/home_page6_content_backup_20260905_111625.txt, scripts/poc-evidence/home_page6_content_backup_20260905_111658.txt, server/counselbot/tenants/1_wellperion.json, server/counselbot/tenants/1_wellperion_qa.json, server/erp_api/seed_faq/1_wellperion.json, status/drafts/dlive_ip_request_20260902.md, status/drafts/dlive_msg_templates_confirmed_20260910.md, status/monthly_ops_plan.json, status/reception_rows_cache.json
- **inquiry_path**: scripts/graphify-out/cache/ast/v0.9.31/5c03e52a8ad498d816c2c320d33cba9f68866bd24448b8a01ded45950db29c26.json, scripts/graphify-out/graph.json, scripts/poc-evidence/home_page6_content_backup_20260905_111625.txt, scripts/poc-evidence/home_page6_content_backup_20260905_111658.txt, scripts/tenants/wellperion.json, scripts/wordpress_admin_playwright.py, server/counselbot/tenants/1_wellperion.json, server/counselbot/tenants/1_wellperion_qa.json, server/erp_api/api_chat.py, server/erp_api/seed_faq/1_wellperion.json, status/coo_page_guard.json, status/drafts/blog_survey_reply_20260902.md, status/gas_push_baseline.json, status/monthly_ops_plan.json, status/schedule_ssot.json
...
- **aws_server_eip**: 3. 웰페리온 가이드/cto/AWS_ERP_운영가이드.html, 3. 웰페리온 가이드/wellperion_guide(main).html, qa_screenshots/auto_status_now.txt, status/evening_wraps/2026-09-04.json, status/monthly_ops_plan.json, status/push_approvals.json, status/welly_auto_runner_state.json
