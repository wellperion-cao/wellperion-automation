# 🛡️ 재발방지 회귀감시
_갱신: 2026-08-12 · 자동 산출(ssot/incident_regression_monitor.py)_

## 판정: ⚠️ 회귀 감지

| 검사 | 결과 |
|---|---|
| 신규 캐논 발산(baseline 초과) | 21건 · inquiry_path, telegram_chat_id, bot_token_key, company_scale, report_bot_handle, sales_year_target, rule:cta_channel_rules, rule:gm_approval_gate_5 |
| 가드 자산 무결 | OK |
| 박제 무결(GUARDED) | OK |
