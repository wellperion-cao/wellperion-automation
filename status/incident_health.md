# 🛡️ 재발방지 회귀감시
_갱신: 2026-08-13 · 자동 산출(ssot/incident_regression_monitor.py)_
...
- **telegram_chat_id**: .deploy-funnel-v2/Survey.js, .deploy-intake/Intake.js, scripts/kakao_auto_daily_report.py, scripts/kakao_report_sender.py, scripts/module_reporter.py, scripts/naver_talktalk_custommenu.py, scripts/weekly_marketing_feedback.py, status/gas_push_baseline.json, status/kungjjak_today.json, tests/test_room_routing.py
