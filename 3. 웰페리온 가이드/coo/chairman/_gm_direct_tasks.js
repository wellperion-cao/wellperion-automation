...
(function () {
  ...
  var CATEGORY_BY_ID = {
    ...
    '2026-08-31': '매출 및 영업',  // 8월 매출 부족분을 무엇으로 채울 것인가 — 격차 4,950만원 축 확정(2026-08-10 GM 지시)
    '2026-08-32': '매출 및 영업',  // 회원권 요금 인상 2026년 10월 시행 준비 — 실행은 시포, GM이 챙기는 건(2026-08-10 GM 결정)
