...
CELL_TAG = {
    ...
    # 2026-09-16 시포 실측(9/8~9/15 결제 191건) — 브로제이 분류에 골프·스쿼시·유료GX 가 실제로 쓰이고 있었다.
    # 짝이 없어 골프 43만·스쿼시 309만이 엿새 내내 '미이관'으로 잡혔는데 실은 이 표의 구멍이었다.
    # 뮤지컬 = 브로제이 실제 분류명 「영어뮤지컬」(GM: 뮤지컬·영어뮤지컬은 같은 것, 영어뮤지컬로 통일 ·
    # 2026-09-17 웰리 실측 9/16 2,520,000 = 시트 I14 일치 · 종전 「뮤지컬」은 짝이 안 지어졌다).
    "I10": "골프", "I11": "스쿼시", "I14": "영어뮤지컬", "I15": "유료GX",
}
